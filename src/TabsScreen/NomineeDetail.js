...
export default class NomineeDetail extends Component {
    ...
    onVote = () => {
        ...
        const url = ApiCommon.base_url + "castyourvote?token=" + this.access_token + "&category_id=" + this.awardid + "&nominee_id=" + this.nomineeid;
        console.log(url);
        //  alert(url);
        fetch(url, options)
            .then(response => response.json())
                ...
                <ImageBackground imageStyle={{ borderBottomLeftRadius: 30, borderBottomRightRadius: 30 }}
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity style={{
                            ...
                            elevation: 5, justifyContent: 'center', marginBottom: 30, backgroundColor: '#ffffff', height: 50, width: 120, borderRadius: 50, alignSelf: 'center'
                        }}
                            onPress={() => this.onVote()}>
