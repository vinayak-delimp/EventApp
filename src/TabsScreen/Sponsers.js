...
import { FlatList, Alert, View, ImageBackground, Image, Text, StyleSheet, Dimensions } from 'react-native';
...
export default class Sponsers extends Component {
  ...
  constructor(props) {
    ...
    this.sponsersData = [
      ...
      {
        "name": "Department Jobs, Tourism",
        "info": "",
        "image": require('../../assets/images/spnsr/sp41.png')
      },
      {
        "name": "Defence West",
        "info": "",
      ...
      },
      {
        ...
        "info": "",
        "image": require('../../assets/images/spnsr/sp42.png')
      },
      ...
      <ImageBackground
        ...
        <View
          ...
          showsVerticalScrollIndicator={false}
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                onPress={() => this.onViewSponser(item)}
                style={
        ...
        flexWrap: 'wrap'}}
            ...
            renderItem={({ item }) =>
              ...
              flexWrap: 'wrap' }}>
                <TouchableOpacity
                  onPress={() => this.onViewSponser(item)} style={{ justifyContent: 'center', backgroundColor: '#FFFFFF', borderRadius: 10, padding: 5, margin: 5 }}>
                  <Image
